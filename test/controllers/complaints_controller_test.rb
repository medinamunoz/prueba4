...
class ComplaintsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create complaint" do
    assert_difference('Complaint.count') do
      post complaints_url, params: { complaint: { company_id: @complaint.company_id, name: @complaint.name, theme: @complaint.theme } }
    end
  ...
  test "should update complaint" do
    patch complaint_url(@complaint), params: { complaint: { company_id: @complaint.company_id, name: @complaint.name, theme: @complaint.theme } }
