...
ActiveRecord::Schema.define(version: 20170314153351) do
  ...
  create_table "complaint_users", force: :cascade do |t|
    ...
    t.datetime "created_at",   null: false
    t.datetime "updated_at",   null: false
    t.index ["complaint_id"], name: "index_complaint_users_on_complaint_id", using: :btree
    t.index ["user_id"], name: "index_complaint_users_on_user_id", using: :btree
  end
